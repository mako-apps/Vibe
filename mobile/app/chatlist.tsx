...
export default function ChatListScreen({
    ...
    }, [removeMessageLocally, deleteFailedMessage]);
    ...
    }, [messages, handleBubbleMenuAction, onReplySwipeHaptic, openReplyComposer, commitReactionLocally, effectiveChatId, sendMessage, onTypingStatusChange, onRecordingUiChange, replyTo, shouldUseNativeList, showToast, extractNativePayload, sendDebug]);
    ...
    const handleSend = useCallback(() => {
        ...
        if (editTarget) {
            ...
            setText('');
            void (async () => {
                const ok = await editMessage(effectiveChatId, targetMessageId, currentText);
                if (ok) {
    ...
    }, [text, effectiveChatId, isConnected, ghostData, pendingGhost, runQueuedSend, editTarget, editMessage, showToast, replyTo, nativeChatEnabled]);
