...
export const VibeAgentLogo = ({ size = 24, color = "#111111" }: { size?: number, color?: string }) => (
    <Svg width={size} height={size} viewBox="0 0 699 699">
        <Path fill={color} d="M79 136L230 156L291 286L176 199Z" />
        <Path fill={color} d="M327 174L540 199L503 321Z" />
        <Path fill={color} d="M215 103L284 239L328 352L368 492L398 644L498 338Z" />
    </Svg>
);
