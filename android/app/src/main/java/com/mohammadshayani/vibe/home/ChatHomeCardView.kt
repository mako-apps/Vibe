...
internal class ChatHomeCardView(context: Context) : FrameLayout(context) {
  companion object {
  ...
  private val onlineDot = FrameLayout(context)
  ...
  init {
    ...
    avatarFallbackIcon.setImageResource(android.R.drawable.ic_menu_myplaces)
